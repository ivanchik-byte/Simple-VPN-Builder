			...
			Replies: []BotReplyDefinition{
				{
					...
					Placeholders: "%s (invitation link), %d (invited count), %d (bonus days earned)",
					Rows:         4,
					DefaultText:  "Referral Program\n\nInvite friends and earn complimentary subscription time.\n\n- Your friend receives bonus days on their first plan.\n- You receive bonus days credited directly to your active subscription for each successful referral.\n\nYour Invitation Link:\n%s\n\nTotal Invited: %d friends\nBonus Earned: %d days",
				},
				{
					...
					Placeholders: "None",
					Rows:         3,
					DefaultText:  "New Referral Registered\n\nA friend has registered using your invitation link. When they activate a paid plan, bonus days will be credited to your account.",
				},
				{
					...
					Placeholders: "None",
					Rows:         3,
					DefaultText:  "Referral Bonus Credited\n\nYour invited referral completed a subscription purchase! Bonus days have been added to your subscription expiration date.",
				},
			},
		},
	}
